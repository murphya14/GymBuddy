...
app.config['MONGO_URI'] = \
    'mongodb+srv://murphya14:gymbuddy@gymbuddy-asswz.mongodb.net/gym_buddy?retryWrites=true&w=majority'
mongo = PyMongo(app)
...
def index():
    ...
    return render_template('index.html', user=mongo.db.user.find(),
...
def get_user(user_id):
    ...
    return render_template('work_out.html', user=user, workout=workout,
                           user_id=user_id, user__id=user_id)
...
def edit_weight(user_id):
    ...
    user_week = user['week']
    workout = mongo.db.week1_day1.find_one({'week': user_week})
    return render_template('edit_weight.html', workout=workout,
...
def edit_user(user_id):
    ...
    return render_template('edit_user.html', user=user,
                           workout=the_workout, user_id=user_id)
